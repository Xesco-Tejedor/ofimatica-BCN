    ...
    integrated: [
        {
            ...
            questions: [
                ...
                {
                    type: 'short_answer',
                    question: 'Quin és l\'import total a pagar (pressupost + taxa + IVA sobre el total)? Respon només el número sense €.',
                    correct_answers: ['10696.40', '10696,40', '10696.4', '10696,4'],
                    case_sensitive: false,
                    points: 20,
                ...
                {
                    type: 'fill_blank',
                    question: 'El termini de resolució per a llicències d\'obres menors sol ser de _____ dies hàbils.',
                    correct_answer: '30',
                    case_sensitive: false,
                    points: 10,
                ...
                {
                    type: 'order',
                    question: 'Ordena els passos per processar un expedient de llicència:',
                    items: [
                        'Notificar resolució a l\'interessat',
                        'Registrar expedient a la base de dades',
                        'Calcular taxes i imports',
                        'Verificar documentació presentada',
                        'Resoldre l\'expedient (concedir/denegar)'
                    ],
                    correct_order: [3, 1, 2, 4, 0],
                    points: 20,
        ...
        },
        {
            ...
            questions: [
                ...
                },
                {
                    ...
                    correct_answers: ['8000', '8.000', '8000€', '8.000€'],
                    case_sensitive: false,
                    points: 15,
                ...
                {
                    type: 'order',
                    question: 'Ordena els passos del procés de gestió de la subvenció:',
                    items: [
                        'Notificar resolució a l\'entitat',
                        'Registrar sol·licitud al sistema',
                        'Verificar documentació presentada',
                        'Calcular import de subvenció en Excel',
                        'Redactar resolució de concessió en Word',
                        'Valorar la sol·licitud segons criteris'
                    ],
                    correct_order: [2, 1, 5, 3, 4, 0],
                    points: 20,
                ...
                {
                    type: 'fill_blank',
                    question: 'Si la sol·licitud es va presentar el 18/02/2026 i el termini és de 2 mesos, la data límit de resolució és el _____ de 2026.',
                    correct_answer: '18 d\'abril',
                    case_sensitive: false,
                    points: 10,
                ...
                },
                {
                    ...
                    correct_answers: ['CIF', 'el CIF', 'NIF'],
                    case_sensitive: false,
                    points: 10,
                    explanation: 'El CIF (Codi d\'Identificació Fiscal) identifica de forma única les entitats jurídiques.'
                }
            ],
            total_points: 90,
            pass_score: 60
        },
        {
            ...
            questions: [
                ...
                {
                    type: 'short_answer',
                    question: 'Quin és el cost total per als 80 assistents?',
                    correct_answers: ['960', '960€', '960 €'],
                    case_sensitive: false,
                    points: 10,
                ...
                {
                    type: 'order',
                    question: 'Ordena els passos per organitzar l\'esdeveniment:',
                    items: [
                        'Confirmar assistència als 80 primers inscrits',
                        'Redactar convocatòria en Word',
                        'Crear full de càlcul de pressupost en Excel',
                        'Publicar la convocatòria',
                        'Registrar inscripcions en base de dades',
                        'Notificar llista d\'espera als 15 restants'
                    ],
                ...
                {
                    type: 'fill_blank',
                    question: 'Per calcular el percentatge d\'ocupació, la fórmula seria: (Places ocupades / Places disponibles) × _____',
                    correct_answer: '100',
                    case_sensitive: false,
                    points: 10,
